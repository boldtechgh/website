    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <p class="mb-4">BoldTech is an information communications technology focused entity. We have over the
                    years provided end-to-end services to a growing number of clients within and outside the shores of
                    Ghana.</p>
